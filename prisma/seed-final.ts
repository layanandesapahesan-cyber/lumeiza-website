// prisma/seed-final.ts
import { PrismaClient } from '@prisma/client'

// Buat instance PrismaClient langsung dengan URL dari environment
const prisma = new PrismaClient()

async function main() {
  console.log('🌱 Seeding products with Prisma Client...')
  ...
  try {
    ...
    // Test query untuk memastikan koneksi benar-benar berfungsi
  ...
  try {
    ...
    console.log('⚠️ No products to delete or table empty')
  }
  ...
  const products = [
    ...
    },
    {
      ...
      fileUrl: '/downloads/icon-bisnis-startup.zip',
      tags: ["Best Seller"],
      downloads: 3456,
      featured: true
    },
    {
      ...
      fileUrl: '/downloads/icon-sosial-media-pack.zip',
      tags: ["Popular"],
      downloads: 2345,
      featured: false
    },
    {
      ...
      fileUrl: '/downloads/icon-ecommerce.zip',
      tags: ["New"],
      downloads: 567,
      featured: false
    },
    {
      ...
      price: 85000,
      imageUrl: 'https://images.unsplash.com/photo-1581291518633-83b4ebd1d83e?w=400',
      fileUrl: '/downloads/icon-pendidikan.zip',
      tags: ["Sale"],
      downloads: 789,
      featured: false
    },
    ...
    // ILUSTRASI Products
    {
      ...
      fileUrl: '/downloads/ilustrasi-karakter-3d-vol1.zip',
      tags: ["Best Seller", "New"],
      downloads: 890,
      featured: true
    },
    {
      ...
      fileUrl: '/downloads/ilustrasi-flat-design.zip',
      tags: ["Popular"],
      downloads: 2341,
      featured: false
    },
    {
      ...
      fileUrl: '/downloads/ilustrasi-isometric.zip',
      tags: ["New"],
      downloads: 456,
      featured: false
    },
    {
      ...
      fileUrl: '/downloads/ilustrasi-storytelling.zip',
      tags: ["Sale"],
      downloads: 234,
      featured: false
    },
    ...
    // TEMPLATE Products
    {
      ...
      fileUrl: '/downloads/template-presentasi-bisnis.pptx',
      tags: ["Best Seller"],
      downloads: 5678,
      featured: true
    },
    {
      ...
      price: 210000,
      imageUrl: 'https://images.unsplash.com/photo-1611162616305-c69b3fa7fbe0?w=400',
      fileUrl: '/downloads/template-social-media.zip',
      tags: ["Sale", "Popular"],
      downloads: 3456,
      featured: false
    },
    {
      ...
      fileUrl: '/downloads/template-cv-portfolio.zip',
      tags: ["New"],
      downloads: 789,
      featured: false
    },
    ...
    // LOTTIE Products
    {
      ...
      price: 120000,
      imageUrl: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=400',
      fileUrl: '/downloads/lottie-animasi-loading.json',
      tags: ["New", "Popular"],
      downloads: 1234,
      featured: false
    },
    {
      ...
      price: 160000,
      imageUrl: 'https://images.unsplash.com/photo-1557804506-669a67965ba0?w=400',
      fileUrl: '/downloads/lottie-icon-animasi.json',
      tags: ["Best Seller"],
      downloads: 2345,
      featured: true
    }
  ...
  // Tampilkan beberapa produk sebagai sampel
