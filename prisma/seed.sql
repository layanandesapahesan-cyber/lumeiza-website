...
('Logo Premium Minimalis', 'logo-premium-minimalis', 'Koleksi 100 logo modern minimalis untuk brand identity', 'Logo', 350000, 'https://images.unsplash.com/photo-1689840895547-71434f492618?w=400', NULL, ARRAY['Featured','Best Seller'], true, 567, NOW(), NOW()),
('Undangan Pernikahan Digital', 'undangan-pernikahan-digital', 'Template undangan digital elegan untuk pernikahan modern', 'Undangan Digital', 150000, 'https://images.unsplash.com/photo-1519741497674-611481863552?w=400', NULL, ARRAY['New'], false, 234, NOW(), NOW());
